...
- **React 18** + **Vite**
- **d3-geo** (`geoMercator` projeksiyonu, `geoCentroid` mesafe hesabı için)
- Harita verisi: [alpers/Turkey-Maps-GeoJSON](https://github.com/alpers/Turkey-Maps-GeoJSON) (`tr-cities.json`)
